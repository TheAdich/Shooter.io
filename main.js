...
function tryStartGameLoop() {
    if (isPlayerInitialized && isObstacleInitialized && !gameLoopStarted && isAllImagesLoaded) {
...
function gameLoop() {
    if(!isPlayerInitialized || !isObstacleInitialized) return;
...
socket.on('playerMoved',(data)=>{
    if(otherPlayers[data.id]){
        // otherPlayers[data.id].row=data.row;
        // otherPlayers[data.id].col=data.col;
        // otherPlayers[data.id].pixelX=data.col*CELL_SIZE;
        // otherPlayers[data.id].pixelY=data.row*CELL_SIZE;
